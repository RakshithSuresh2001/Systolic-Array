...
add_pdn_stripe -grid {top} -layer {M3} -width {0.162} -spacing {0.072} -pitch {1.152} -offset {0.300}
add_pdn_stripe -grid {top} -layer {M4} -width {0.120} -spacing {0.072} -pitch {1.152} -offset {0.300}
add_pdn_stripe -grid {top} -layer {M5} -width {0.2160} -spacing {0.072} -pitch {1.35} -offset {0.300}
add_pdn_stripe -grid {top} -layer {M6} -width {0.576} -spacing {0.096} -pitch {1.344} -offset {0.513}
add_pdn_stripe -grid {top} -layer {M7} -width {0.576} -spacing {0.096} -pitch {1.344} -offset {0.513}
